...
var movie = 
console.log(movie)  // prints: undefined
...
if (isFavorite === true) {
    ...
    console.log(`I recently read the book ${title} book!`);
};
...
var books = ['The Prophet', 'All the Rain Promises and More', 'David Copperfield', 'Mass Effect', 'Death of the Liberal Class'];
...
var belowTwoHundred = [99, 45, 195, 89, 69, 12, 3, 145, 44, 29, 147, 177];
